##### t_dyn versus Mr for a structure file ###########
...
R1 = (10**(np.transpose(np.genfromtxt('/Users/hermit/Observatory/StarCalc/SMS/Z0_Accr_1e-1_fitm0.999_vvx_n10_iover0/P002z0S0.v0025921.gz',skip_header=3, skip_footer=2))[4]))**3
...
T_dyn1 = ((R1)/(2*G*Mr1))**0.5

#M=4.3088*10**34
#T_dyn1 = ((R**3)/2*G*M)**0.5
#T_dyn1
...
fig,ax=plt.subplots()
ax.plot(Mr1,T_dyn1,color='tab:blue',linewidth=2.2, label="0.1 M$_{\odot}/yr$ model at M = 21.68 $M_{\odot}$ and $logL = 5.30$")
