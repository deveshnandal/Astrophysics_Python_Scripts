...
axs[0].plot(10.109073569991084, -0.016867925287295537, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[1].plot(10.109073569991084, -1.1537218112108867, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[0].plot(9.141451345135723, -0.016867925287295537, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[1].plot(9.141451345135723, -1.1537218112108867, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[0].plot(8.445479690283769, -0.016867925287295537, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[0].plot(8.144825948004701, -0.016867925287295537, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[0].plot(7.8439842013422565, -0.016867925287295537, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[1].plot(8.445479690283769, -1.1537218112108867, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[1].plot(8.144825948004701, -1.1537218112108867, marker='*', color='blue', markersize=12, label='90%', linestyle='None')
axs[1].plot(7.8439842013422565, -1.1537218112108867, marker='*', color='blue', markersize=12, label='90%', linestyle='None')

axs[0].plot(10.25339868845647, 0.02380291467262473, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[1].plot(10.25339868845647, -0.9563886919738228, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[0].plot(9.273956163257083, 0.02380291467262473, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[1].plot(9.273956163257083, -0.9563886919738228, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[0].plot(8.576861472272656, 0.02380291467262473, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[0].plot(8.276066461175425, 0.02380291467262473, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[0].plot(7.975154005490858, 0.02380291467262473, marker='*', color='brown', markersize=12, label='60%', linestyle='None')

axs[1].plot(8.576861472272656, -0.9563886919738228, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[1].plot(8.276066461175425, -0.9563886919738228, marker='*', color='brown', markersize=12, label='60%', linestyle='None')
axs[1].plot(7.975154005490858, -0.9563886919738228, marker='*', color='brown', markersize=12, label='60%', linestyle='None')




axs[0].plot(10.334694979304546, 0.07058107428570727, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[1].plot(10.334694979304546, -0.5271575432596126, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[0].plot(9.352444451110248, 0.07058107428570727, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[1].plot(9.352444451110248, -0.5271575432596126, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[0].plot(8.655087855223067, 0.07058107428570727, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[0].plot(8.354259957709539, 0.07058107428570727, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[0].plot(8.05333104639898, 0.07058107428570727, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')

axs[1].plot(8.655087855223067, -0.5271575432596126, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[1].plot(8.354259957709539, -0.5271575432596126, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')
axs[1].plot(8.05333104639898, -0.5271575432596126, marker='*', color='magenta', markersize=12, label='CO core', linestyle='None')

axs[0].errorbar(7.70,-0.18, xerr=0.11, yerr=0.18, fmt='o', color='magenta')
axs[1].plot(7.70,-0.75,  marker='*', color='magenta', markersize=12, linestyle='None')
axs[1].errorbar(7.70,-0.75,  xerr=0.11, yerr=0.18, fmt='o', color='magenta')
