...
fig,ax=plt.subplots()
ax.plot(Mtot,-I1_list/-I0_list,color='tab:blue',linewidth=2.,label='I$_+$')
ax.plot(Mtot,I2_tot_list/-I0_list,color='tab:red',linewidth=2.,label='I$_-$')
#ax.plot(Mtot,(-I1_list/-I0_list)-(I2_tot_list/-I0_list),color='tab:green',linewidth=2.,label='I$_-$')
...
fig,ax=plt.subplots()
ax.plot(Mtot,-I1_list,color='tab:blue',linewidth=2.,label='I$_+$')
#ax.plot(Mtot,I2_tot_list,color='tab:red',linewidth=2.,label='I$_-$')
#ax.plot(Mtot,(-I1_list/-I0_list)-(I2_tot_list/-I0_list),color='tab:green',linewidth=2.,label='I$_-$')
ax.legend(loc='upper center', shadow=True,prop={'size': 8})
ax.set_xlabel('Mass [M$_{\odot}$]')
ax.set_ylabel('GRIntegrals')
