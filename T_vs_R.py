######### T vs M 0.1 Msun model ###########

import math
import pandas as pd
import matplotlib.pyplot as plt

T = (np.transpose(np.genfromtxt('/Users/devesh/Observatory/StarCalc/SMS/Z0_Accr_1e-1_fitm0.999_vvx_n10_iover0/P002z0S0_StrucData_0143341.dat',skip_header=12))[3])
R = (np.transpose(np.genfromtxt('/Users/devesh/Observatory/StarCalc/SMS/Z0_Accr_1e-1_fitm0.999_vvx_n10_iover0/P002z0S0_StrucData_0143341.dat',skip_header=12))[1])
x1 = [9.6358]
y1 = [8.176]
x2 = [11.1505]
y2 = [8.165]
...
plt.text(9.502, 7.971, '0.0002M$_{\odot}$', fontsize = 8)
plt.text(10.956, 7.981, '43.60M$_{\odot}$', fontsize = 8)
plt.text(12.733, 7.941, '45188M$_{\odot}$', fontsize = 8)
plt.text(13.601, 6.866, '96012M$_{\odot}$', fontsize = 8)
plt.text(13.585, 5.369, '103140M$_{\odot}$', fontsize = 8)
plt.text(14.084, 3.889, '104037M$_{\odot}$', fontsize = 8)
