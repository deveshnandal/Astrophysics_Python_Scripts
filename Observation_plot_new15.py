...
def process_data(filepath, skip_header, m_ejecta, label, index_cutoff, annotation_offset=(0, 0), plot_axes=None, plot_axes2=None, plot_colorbar=False):
    ...
    color_mapping = {1: 'blue', 10: 'cyan', 100: 'green', 500: 'orange', 1000: 'black'}
    f_values = [1,10,100,500,1000]#np.logspace(-1, 3, 50)# change the range to be more reasonable for popIII stars.
    dM = np.diff(M_sol)
    ...
    if plot_colorbar:
        ...
        sm.set_array([])
        cbar = fig.colorbar(sm, cax=cbar_ax, aspect=30, ticks=[1, 10, 100, 500, 1000])
        cbar.set_ticks([0.0, 0.25, 0.5, 0.75, 1.0])
        cbar.set_ticklabels([1, 10, 100, 500, 1000])
...
filepaths = [
    ('/Users/hermit/Observatory/StarCalc/SMS/3.5e-3Msun_yr/P002Z0S0.v0173881', 310, 7740, '8913', -72, (0, 0.05)),
...
axs[0].plot(9.5320, -0.120, marker='p', color='blue', markersize=10, label='90%', linestyle='None')
axs[1].plot(9.5320, -1.17, marker='p', color='blue', markersize=10, label='90%', linestyle='None')
axs[0].plot(8.6783, -0.120, marker='p', color='cyan', markersize=10, label='90%', linestyle='None')
axs[1].plot(8.6783, -1.17, marker='p', color='cyan', markersize=10, label='90%', linestyle='None')
axs[0].plot(7.6960, -0.120, marker='p', color='green', markersize=10, label='90%', linestyle='None')
axs[1].plot(7.6960, -1.17, marker='p', color='green', markersize=10, label='90%', linestyle='None')
axs[0].plot(6.9987, -0.120, marker='p', color='orange', markersize=10, label='90%', linestyle='None')
axs[1].plot(6.9987, -1.17, marker='p', color='orange', markersize=10, label='90%', linestyle='None')
axs[0].plot(6.6978, -0.120, marker='p', color='black', markersize=10, label='90%', linestyle='None')
axs[1].plot(6.6978, -1.17, marker='p', color='black', markersize=10, label='90%', linestyle='None')

axs[0].plot(9.7115, -0.03, marker='p', color='blue', markersize=10, label='60%', linestyle='None')
axs[1].plot(9.7115, -0.82, marker='p', color='blue', markersize=10, label='60%', linestyle='None')
axs[0].plot(8.8105, -0.03, marker='p', color='cyan', markersize=10, label='60%', linestyle='None')
axs[1].plot(8.8105, -0.82, marker='p', color='cyan', markersize=10, label='60%', linestyle='None')
axs[0].plot(7.8217, -0.03, marker='p', color='green', markersize=10, label='60%', linestyle='None')
axs[1].plot(7.8217, -0.82, marker='p', color='green', markersize=10, label='60%', linestyle='None')
axs[0].plot(7.1238, -0.03, marker='p', color='orange', markersize=10, label='60%', linestyle='None')
axs[1].plot(7.1238, -0.82, marker='p', color='orange', markersize=10, label='60%', linestyle='None')
axs[0].plot(6.8229, -0.03, marker='p', color='black', markersize=10, label='60%', linestyle='None')
axs[1].plot(6.8229, -0.82, marker='p', color='black', markersize=10, label='60%', linestyle='None')

axs[0].plot(9.6625, 0.06, marker='p', color='blue', markersize=10, label='CO core', linestyle='None')
axs[1].plot(9.6625, -0.64, marker='p', color='blue', markersize=10, label='CO core', linestyle='None')
axs[0].plot(8.7536, 0.06, marker='p', color='cyan', markersize=10, label='CO core', linestyle='None')
axs[1].plot(8.7536, -0.64, marker='p', color='cyan', markersize=10, label='CO core', linestyle='None')
axs[0].plot(7.7638, 0.06, marker='p', color='green', markersize=10, label='CO core', linestyle='None')
axs[1].plot(7.7638, -0.64, marker='p', color='green', markersize=10, label='CO core', linestyle='None')
axs[0].plot(7.0658, 0.06, marker='p', color='orange', markersize=10, label='CO core', linestyle='None')
axs[1].plot(7.0658, -0.64, marker='p', color='orange', markersize=10, label='CO core', linestyle='None')
axs[0].plot(6.7649, 0.06, marker='p', color='black', markersize=10, label='CO core', linestyle='None')
axs[1].plot(6.7649, -0.64, marker='p', color='black', markersize=10, label='CO core', linestyle='None')
...
# Connecting lines
axs[0].plot((9.5320, 8.6783, 7.6960, 6.9987, 6.6978), (-0.120, -0.120, -0.120, -0.120, -0.120), color="red", linestyle="-", label=None, linewidth=2.0)
axs[1].plot((9.5320, 8.6783, 7.6960, 6.9987, 6.6978), (-1.17, -1.17, -1.17, -1.17, -1.17), color="red", linestyle="-", label=None, linewidth=2.0)
axs[0].plot((9.7115, 8.8105, 7.8217, 7.1238, 6.8229), (-0.03, -0.03, -0.03, -0.03, -0.03), color="brown", linestyle="-", label=None, linewidth=2.0)
axs[1].plot((9.7115, 8.8105, 7.8217, 7.1238, 6.8229), (-0.82, -0.82, -0.82, -0.82, -0.82), color="brown", linestyle="-", label=None, linewidth=2.0)
axs[0].plot((9.6625, 8.7536, 7.7638, 7.0658, 6.7649), (0.06, 0.06, 0.06, 0.06, 0.06), color="magenta", linestyle="-", label=None, linewidth=2.0)
axs[1].plot((9.6625, 8.7536, 7.7638, 7.0658, 6.7649), (-0.64, -0.64, -0.64, -0.64, -0.64), color="magenta", linestyle="-", label=None, linewidth=2.0)
